...
export default class ValidatedTextField {
  public static tpList: TextFieldDef[] = [
    ValidatedTextField.tp('string', 'A basic string'),
    ...
    ValidatedTextField.tp('float', 'A decimal', (str) => !isNaN(Number(str)), undefined, undefined, 'decimal'),
    ValidatedTextField.tp(
      'pfloat',
    ...
    ValidatedTextField.tp('email', 'An email adress', (str) => EmailValidator.validate(str), undefined, undefined, 'email'),
    ValidatedTextField.tp(
      'url',
      'A url',
      (str) => {
