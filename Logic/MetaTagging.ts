...
export default class MetaTagging {
  ...
  private static createRetaggingFunc(layer: LayerConfig): (params: Params, feature: any) => void {
        ...
        const f = (featuresPerLayer, feature: any) => {
          try {
            ...
            if (MetaTagging.errorPrintCount < MetaTagging.stopErrorOutputAt) {
              console.warn(
                'Could not calculate a calculated tag defined by ' +
                  code +
                  ' due to ' +
                  e +
                  '. This is code defined in the theme. Are you the theme creator? Doublecheck your code. Note that the metatags might not be stable on new features',
                e
              );
